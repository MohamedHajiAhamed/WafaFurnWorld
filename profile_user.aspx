<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="profile_user.aspx.cs" Inherits="Electronic_Kingdom.profile_user" %>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       <a href="profile_user.aspx"><button type="button" id="model-close"  class="btn btn-danger"  data-bs-dismiss="modal">Close</button></a> 
      </div>
    </div>
  </div>
</div>
